...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241028213242_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 28, 17, 32, 42, 174, DateTimeKind.Local).AddTicks(7370),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 28, 17, 32, 42, 174, DateTimeKind.Local).AddTicks(7402),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 28, 17, 32, 42, 174, DateTimeKind.Local).AddTicks(7404),
                            ServicesID = 5
                        });
                });
